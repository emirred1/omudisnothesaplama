          ...
          <div className={`mt-6 rounded-[32px] p-8 transition-all duration-500 min-h-[140px] flex items-center justify-center ${
            ...
            {isCalculating ? (
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-500">Hesaplanıyor...</p>
              </div>
            ) : !results.ready ? (
              ...
              <div className="flex justify-between items-end w-full">
                ...
                <div className="text-right flex flex-col items-end">
                  ...
                  {Number(scores.final) < 50 && scores.final !== '' && (
                    <p className="text-[8px] text-red-500 font-bold uppercase mt-1 animate-pulse tracking-tighter">! Final Barajı</p>
                  )}
                </div>
              </div>
            )}
